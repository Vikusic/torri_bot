...
#
# if not os.path.isfile(f'./{DB_FILENAME}'):     #яляется ли путь файлом
...
#
#
# #BASE_MEDIA_PATH = './demo_media'
# BASE_MEDIA_PATH = './'
#
# os.listdir(path = "./")
#
# async def uploadMediaFiles(folder, method, file_attr):
#     folder_path = os.path.join(BASE_MEDIA_PATH, folder)    #os.path.join(path1[, path2[, ...]]) - соединяет пути с учётом особенностей операционной системы.
...
# print(a)
# tasks = [
#     loop.create_task(uploadMediaFiles('media', bot.send_photo, 'photo')),
